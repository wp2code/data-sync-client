...
public class AiEnvConfig {
     ...
     * 批量保存接口默认路径
     */
    public static final String DEFAULT_SAVE_API = "/pilot/training/knowledge/save";
     ...
     * 触发训练接口默认路径
     */
    public static final String DEFAULT_TRAIN_API = "/pilot/training/knowledge/train";

    /**
     * 批量更新用户接口默认路径
     */
    public static final String DEFAULT_UPDATE_USER_API = "/pilot/training/knowledge/updateUser";
